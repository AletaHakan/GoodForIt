...
public class SignInActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
            ...
            case R.id.skip_text:
                mFirebaseAuth.signInAnonymously().addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(SignInActivity.this, "Unable to sign in anonymously.",
    ...
    private void onAuthSuccess(FirebaseUser firebaseUser) {
        ...
        User user = new User(firebaseUser.getEmail(), firebaseUser.getDisplayName(), null, timestampCreated);

        FirebaseUtil.getBaseRef().child("users").child(firebaseUser.getUid()).setValue(user);
